...
class OptimisticAllocatorProcess : public MesosAllocatorProcess
{
public:
  OptimisticAllocatorProcess()
    : ProcessBase(process::ID::generate("optimistic-allocator")) {}

  virtual ~OptimisticAllocatorProcess() {}
